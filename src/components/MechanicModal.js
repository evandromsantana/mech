...
export default ({ show, setShow, user, service }) => {
    ...
    useEffect(()=>{
        if(use.available && selectedDay > 0) {
            ...
            <ModalArea>
                <ModalBody>
                    <CloseButton onPress={handleCloseButton}>
                        <ExpandIcon width="40" height="40" fill="#FF9900" />
                    </CloseButton>
                            ...
                            {listDays.map((item, key)=>(
                                <DateItem 
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: item.number === selectedDay ? '#232F3E' : '#FFFFFF'
                                    }}
                                >
                                    <DateItemWeekDay
                                        style={{
                    ...
                    {selectDay > 0 && listHours.length > 0 &&                    
                        <ModalItem>
                            <TimeList horizontal={true} showsHorizontalScrollIndicator>
                                {listHours.map((item, key)=>(
                                    <TimeItem
                                        ...
                                        style={{
                                            backgroundColor: item === selectedHour ? '#232F3E' : '#FFFFFF'
                                        }}
                                    >
                                        <TimeItemText
                                            style={{
